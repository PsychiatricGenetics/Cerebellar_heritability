...
# Single phenotype
result.single <- as_tibble(Univariate_ACE(phenotype = "Left_I_IIIZ", twin.data = my.data, covariate = c("Sex", "Age", "eTIVZ")))
...
write.csv(result.multiple, "qtab_univariate_ACE_output.csv", row.names = F)
