...
Saturated_covariate <- function(phenotype, twin.data) {
  ...
  defMZF <- mxMatrix(type = "Full", nrow = nc, ncol = ntv, free = F, 
                     labels = c(paste0("data.", covariate, "_01"), paste0("data.", covariate, "_02"), paste0("data.", covariate, "_050")), name = "defMZF")
  defMZM <- mxMatrix(type = "Full", nrow = nc, ncol = ntv, free = F,
                     labels = c(paste0("data.", covariate, "_01"), paste0("data.", covariate, "_02"), paste0("data.", covariate, "_050")), name = "defMZM")
  defDZF <- mxMatrix(type = "Full", nrow = nc, ncol = ntv, free = F,
                     labels = c(paste0("data.", covariate, "_01"), paste0("data.", covariate, "_02"), paste0("data.", covariate, "_050")), name = "defDZF")
  defDZM <- mxMatrix(type = "Full", nrow = nc, ncol = ntv, free = F,
                     labels = c(paste0("data.", covariate, "_01"), paste0("data.", covariate, "_02"), paste0("data.", covariate, "_050")), name = "defDZM")
  defDZOS <- mxMatrix(type = "Full", nrow = nc, ncol = ntv, free = F,
                      labels = c(paste0("data.", covariate, "_01"), paste0("data.", covariate, "_02"), paste0("data.", covariate, "_050")), name = "defDZOS")
  ...
  expCovMZF <- mxMatrix(type = "Symm", nrow = ntv, free = T, values = valDiag(svVa, ntv),
                        labels = c("vMZF1", "cMZF21", "cSib", "vMZF2", "cSib", "vSib"), name = "expCovMZF")
  expCovMZM <- mxMatrix(type = "Symm", nrow = ntv, free = T, values = valDiag(svVa, ntv),
                        labels = c("vMZM1", "cMZM21", "cSib", "vMZM2", "cSib", "vSib"), name = "expCovMZM")
  expCovDZF <- mxMatrix(type = "Symm", nrow = ntv, free = T, values = valDiag(svVa, ntv),
                        labels = c("vDZF1", "cDZF21", "cSib", "vDZF2", "cSib", "vSib"), name = "expCovDZF")
  expCovDZM <- mxMatrix(type = "Symm", nrow = ntv, free = T, values = valDiag(svVa, ntv),
                        labels = c("vDZM1", "cDZM21", "cSib", "vDZM2", "cSib", "vSib"), name = "expCovDZM")
  expCovDZOS <- mxMatrix(type = "Symm", nrow = ntv, free = T, values = valDiag(svVa, ntv),
                         labels = c("vDZOS1", "cDZOS21", "cSib", "vDZOS2", "cSib", "vSib"), name = "expCovDZOS")
